...
formElem.onsubmit = function(event) {
    ...
    /* If we don't do this, the default action can occur as it normally would.
    By including this, the event is cancelled, preventing it from occurring as it normally would. */
    event.preventDefault();

    // QUIZ
    // what happens if we don't do this?
    /* If we don't do this, the error message that appears for an invalid input does not go away,
    even if a valid input is resubmitted.*/
    clearError();
